using Dapper;
using DotNetBatch14KZT2.ConsoleApp3.Dtos;
...
namespace DotNetBatch14KZT2.ConsoleApp3.DapperExamples;

public class DapperExample
{
    private readonly string _connString = AppSettings.connBuilder.ConnectionString;
